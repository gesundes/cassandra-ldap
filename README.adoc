...
* cassandra-4.1 - builds aganist version 4.1.10
* cassandra-5.0 - builds aganist version 5.0.6
...
|required_group_dn
|if set, only users who are members of this LDAP group (full DN) can log in
